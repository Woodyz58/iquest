  ...
  return (
    <>
      <PageTransition>
        <Helmet>
          <meta charSet="utf-8" />
          <title>Our Directors | IT Support Perth | Corporate IT Services Perth | Managed IT Perth</title>
        </Helmet>
        <Header />
              ...
              <main className="mt-10 max-w-2xl px-4 float-left sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-24">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl md:leading-none font-extrabold text-white sm:text-5xl md:text-6xl">
                    <span className="block text-blue-lighter xl:inline">Our Directors</span>
                  </h1>
