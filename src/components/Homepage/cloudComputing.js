          ...
          <div className="px-4 max-w-6xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
            <div>
              <div className="mt-6">
                ...
                <h4 className="max-w-lg mt-2 text-xl font-bold text-gray-600">Local IT Services helping you access your content anywhere!</h4>
                <p className="mt-5 text-normal leading-relaxed text-gray-600">The concept of cloud computing may seem like a relatively new thing but it has been in use for over 10 years. Cloud Computing is a secure server that can be accessed via the internet.</p>
                <p className="mt-5 text-normal leading-relaxed text-gray-600">This allows users to access business applications and store data online without the need for onsite hardware and software. As internet security improves at an exponential rate and NBN gets rolled out across Australia, the Cloud becomes an even more attractive solution.</p>
                <div className="mt-6">
